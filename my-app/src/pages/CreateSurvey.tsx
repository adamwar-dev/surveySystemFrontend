			...
			<React.Fragment>
				...
				<Box sx={{ flexGrow: 1, width:'100%', height:'85vh'}}>
					...
					<Grid item xs={12} sm={6} md={4}>
							<Tile primaryText='Public Survey' linkTo='' icon={<PublicRoundedIcon fontSize={'large'}/>}/>
						</Grid>
						<Grid item xs={12} sm={6} md={4}>
							<Tile primaryText='Private Survey' linkTo='' icon={<PublicOffRoundedIcon fontSize={'large'}/>}/>
						</Grid>
						<Grid item xs={12} sm={12} md={4}>
							<Tile primaryText='Distributed Survey' linkTo='' icon={<SupervisorAccountRoundedIcon fontSize={'large'}/>}/>
						</Grid>
					</Grid>
				</Box>
            </React.Fragment>
